...
function Promocao(){
    return(
        <div className='container'>
            ...
            <h1  className='text-white text-center'>As Melhores promoções Nacionais  você só encontra aqui! </h1>
        </div>

        <div class="card-deck">
            <div class="card card1">
                <img class="card-img-top" src="/img/Jeri.jpg" alt="Card image cap"/>
                <div class="card-body">
            ...
            <div class="card card1">
                <img class="card-img-top" src="/img/ParatyIcone.jpg" alt="Card image cap"/>
                <div class="card-body">
        ...
        <div class="card-deck">
            <div class="card card1">
                <img class="card-img-top" src="/img/ibitipoca.jpg" alt="Card image cap"/>
                <div class="card-body">
            ...
            <div class="card card1">
                <img class="card-img-top" src="/img/cataratas.jpg" alt="Card image cap"/>
                <div class="card-body">
            ...
            <div class="card card1" >
                <img class="card-img-top" src="/img/monte-roraima.jpg" alt="Card image cap"/>
                <div class="card-body">
